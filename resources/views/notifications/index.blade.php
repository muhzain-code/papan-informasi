        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Notifications</h3>
                    <p class="text-subtitle text-muted">Mengelola data notifikasi.</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        <h5 class="card-title mb-0">Data Notifications</h5>

                        <a href="{{ route('notifications.create') }}" class="btn btn-primary mb-3 ms-auto">
                    ...
                    <div class="d-flex justify-content-between flex-wrap mb-4">
                        ...
                        <form method="GET" class="d-flex">
                            <input type="text" name="search" value="{{ $search }}"
                                class="form-control form-control-sm" placeholder="Cari pesan notifikasi...">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @php
                                $no = ($notifications->currentPage() - 1) * $notifications->perPage() + 1;
                            @endphp
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <a href="{{ route('notifications.show', $item->id) }}" class="btn btn-info btn-sm">
                                                <i class="bi bi-eye"></i>
                                            </a>
