        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Detail Course</h3>
                    <p class="text-subtitle text-muted">Informasi lengkap course.</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- CODE --}}
                    <div class="mb-3">
                        <label class="form-label fw-bold">Kode Course</label>
                        <p>{{ $course->code }}</p>
                    </div>

                    {{-- NAME --}}
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nama Course</label>
                        <p>{{ $course->name }}</p>
                    </div>
