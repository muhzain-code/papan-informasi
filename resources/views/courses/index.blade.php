        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Mengelola data mata kuliah yang tersedia.</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        <h5 class="card-title mb-0">Data Courses</h5>
                        <a href="{{ route('courses.create') }}" class="btn btn-primary mb-3 ms-auto">
