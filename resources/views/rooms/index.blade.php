        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Data Ruangan</h3>
                    <p class="text-subtitle text-muted">Mengelola data ruangan yang tersedia.</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        <h5 class="card-title mb-0">Data Rooms</h5>
                        <a href="{{ route('rooms.create') }}" class="btn btn-primary mb-3 ms-auto">
                    ...
                    <div class="d-flex justify-content-between flex-wrap mb-4">
                        ...
                        <form method="GET" class="d-flex">
                            <input type="text" name="search" value="{{ $search }}"
                                class="form-control form-control-sm" placeholder="Cari kode atau nama...">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @php
                                $no = ($rooms->currentPage() - 1) * $rooms->perPage() + 1;
                            @endphp
