        ...
        <div class="sidebar-wrapper active">
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item {{ Str::startsWith($currentRoute, 'admin.index') ? 'active' : '' }}">
                    ...
                    <!-- 
                      Perbaikan: 
                      1. Penambahan class 'active' dinamis pada parent item 'Auth'
                         agar ikut menyala jika submenu-nya aktif.
                      2. Mengubah class 'sidebar-item' menjadi 'submenu-item' pada <li> di dalam <ul> submenu
                         agar sesuai dengan struktur template Mazer.
                    -->
                    <li
                        ...
                        <ul class="submenu {{ Str::startsWith($currentRoute, 'activity.index') || Str::startsWith($currentRoute, 'register') ? 'active' : '' }}">
                            <li
