                    ...
                    <div class="d-flex flex-wrap">
                        <div class="border-end border-primary pe-3">
                            <a href="#" class="text-muted small"><i
                                    class="fas fa-map-marker-alt text-primary me-2"></i>Probolinggo, Indonesia</a>
                        </div>
                        <div class="ps-3">
                            <a href="mailto:ft@unuja.ac.id" class="text-muted small"><i
                                    class="fas fa-envelope text-primary me-2"></i>ft@unuja.ac.id</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <div class="dropdown ms-3">
                            <a href="#" class="dropdown-toggle text-dark" data-bs-toggle="dropdown"><small><i
                                        class="fas fa-globe-europe text-primary me-2"></i> Indonesia</small></a>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a href="#" class="navbar-brand p-0">
                    <h1 class="text-primary mb-0"><i class="fab fa-slack me-2"></i> UNUJA</h1>
                    <!-- <img src="img/logo-unuja.png" alt="Logo"> -->
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-0 mx-lg-auto">
                        <a href="{{ route('home') }}"
                            class="nav-item nav-link {{ Str::startsWith($currentRoute, 'home') ? 'active' : '' }}">Beranda</a>
                        <a href="{{ route('about') }}"
                            class="nav-item nav-link {{ Str::startsWith($currentRoute, 'about') ? 'active' : '' }}">Tentang</a>
                        <a href="{{ route('agenda.index') }}"
                            class="nav-item nav-link {{ Str::startsWith($currentRoute, 'agenda.') ? 'active' : '' }}">Agenda</a>
                        <a href="{{ route('blog.index') }}"
                            class="nav-item nav-link {{ Str::startsWith($currentRoute, 'blog.') ? 'active' : '' }}">Berita</a>
                        ...
                        <a href="{{ route('contact') }}"
                            class="nav-item nav-link {{ Str::startsWith($currentRoute, 'contact') ? 'active' : '' }}">Kontak</a>
                ...
                <div class="d-none d-xl-flex flex-shrink-0 ps-4">
                    ...
                    <div class="d-flex flex-column ms-3">
                        ...
                        <a href="tel:+ 0123 456 7890"><span class="text-dark">(0335) 772073</span></a>
                    </div>
                </div>
            </nav>
        </div>
                    ...
                    <div class="mb-5">
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-6 col-xl-5">
                                <div class="footer-item">
                                    <a href="index.html" class="p-0">
                                        <h3 class="text-white"><i class="fab fa-slack me-3"></i> UNUJA</h3>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-3">
                                <div class="footer-item">
                                    <h4 class="text-white mb-4">Link Navigasi</h4>
